Draft of steps that should be taken when finding a security issue in
Ethereum. Security issue is defined as a problem in scope of
`Security-Categorization <https://github.com/ethereum/wiki/wiki/Security-Categorization>`__.
