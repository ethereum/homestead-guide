...
-  **The Registration of front end resources**: To render the ÐApp, the
...
|  - ``Root Registrar address`` is the address of the root registrar
  contract (used to link the ÐApp with resources. -
  ...
  Mist (or AlethZero) to access to the ÐApp. in italic, you can check
  the formatted ÐApp URL (which will be used by the Ethereum browser)
...
Users can now use Mist or AlethZero to access to the ÐApp, using the
