...
documentation for a contract is an important part of the Ethereum
...
we (the Ethereum foundation) will maintain our own curated repository of
...
`here <https://github.com/ethereum/dapp-bin/blob/master/NatSpecReg/contract.sol>`__.
...
testnet, probably referenced from the Ethereum services contract.
...
Hint <https://github.com/ethereum/wiki/wiki/URL-Hint-Protocol>`__
system.
